<div class="col-md-2">
	<div class="contact-group-list">
		...
		<div class="contact-group sub <?php echo ('addgroup' == $activeList) ? 'active' : ''?>"><a cm-pjax href="?display=dashboard&amp;mod=contactmanager&amp;view=addgroup" class="contact-group-inner">Add Group<i class="fa fa-plus"></i></a></div>
