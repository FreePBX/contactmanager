<div class="col-md-2">
	<div class="contact-group-list">
		...
		<?php foreach($groups as $group) { ?>
			<div class="contact-group sub <?php echo ($group['name'] == $activeList) ? 'active' : ''?>"><a vm-pjax href="?display=dashboard&amp;mod=faxpro&amp;view=send" class="contact-group-inner"><?php echo $group['name']?><span class="badge">21</span></a></div>
		<?php } ?>
	</div>
</div>
