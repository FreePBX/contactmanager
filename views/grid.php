...
<div class="fpbx-container">
	<ul class="nav nav-tabs pb-0" role="tablist">
		<?php foreach($types as $type => $data) { ?>
			<li data-name="<?php echo $type?>" class="change-tab"><a class="nav-link <?php echo $type == "internal" ? "active" : ""?>" href="#<?php echo $type?>" aria-controls="<?php echo $type?>" role="tab" data-toggle="tab"><?php echo $data['name']?></a></li>
		<?php } ?>
				...
				<?php if(!empty($groups[$type])) { ?>
					<div class="nav-container">
						...
						<div class="wrapper mt-3">
							<ul class="nav nav-tabs pb-0 mt-0 list" role="tablist" style="min-width: 10000px;">
							...
							?>
								...
								<li data-name="<?php echo $type?>-<?php echo $group['id']?>" class="change-tab"><a class="nav-link <?php echo $k== 0 ? "active" : ""?>" href="#<?php echo $type?>-<?php echo $group['id']?>" aria-controls="<?php echo $type?>-<?php echo $group['id']?>" role="tab" data-toggle="tab"><?php echo htmlentities($group['name'])?> <?php echo $owner?></a></li>
							<?php } ?>
							</ul>
						</div>
					</div>
