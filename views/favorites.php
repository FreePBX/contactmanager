					...
					<div class="col-md-12">
						<div class="row">
							<div class="form-group">
								...
								<div class="col-md-9"><input id="list_name" name="list_name" class="form-control" data-invalid="<?php echo _("List Name is required.") ?>" value="<?php echo htmlentities($list['list_name'])?>"></div>
							</div>
						</div>
					</div>
				</div>
